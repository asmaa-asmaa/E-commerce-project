<template>
  <div class="footer">
    <v-footer class="bg-grey">
      <v-row class="tabone d-flex justify-space-between w-100">
        <v-col cols="12" md="4" lg="3">
          <v-list>
            ...
            <v-list-item :to="{ name: 'help' }">
              <v-list-title> Help Center </v-list-title>
            </v-list-item>
            <v-list-item :to="{ name: 'contact' }">
              <v-list-title> Contact Us </v-list-title>
            </v-list-item>
            <v-list-item>
              <v-list-title
                style="font-weight: bolder"
            ...
            <v-list-item :to="{ name: 'return' }">
              <v-list-title> Return & Refund Policy </v-list-title>
            </v-list-item>
          </v-list>
        </v-col>
        <v-col cols="12" md="4" lg="3">
          <v-list>
            ...
            <v-list-item>
              <v-list-title> Terms & Conditions </v-list-title>
            </v-list-item>
            <v-list-item>
              <v-list-title> Privacy Policy </v-list-title>
            </v-list-item>
          </v-list>
        </v-col>
        <v-col cols="12" md="4" lg="3">
          <v-list>
            ...
            <v-list-item>
              <v-list-title> Sell Your Product </v-list-title>
            </v-list-item>
          </v-list>
        </v-col>
        <v-col cols="12" md="4" lg="3">
    ...
    <v-row class="tabtwo ml-2">
      <v-col cols="12" md="6" lg="5">
        <v-table class="bg-grey">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <v-icon size="40" class="mb-6">mdi-cash</v-icon>
                <v-html
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 333333 199007"
                ...
                <v-html>
                  ...
                  >
                    <g>
                      <path
                        fill="black"
                        d="M612.9,391.1c2.1-6.7,3.9-13.4,6-20.4c2.6-8.8,5-17.4,7.7-26.1c1.9-6.2,5-8.6,11.4-8.6c4.5,0,9,0,13.4,0
		...
		c5.4,0.2,9.3,3.4,11,8.6c4.3,14.6,8.6,29.1,13.1,43.7c0.2,0.9,0.6,1.7,0.7,2.6C612.4,391.1,612.6,391.1,612.9,391.1z"
                      ...
                      <path
                        fill="black"
                        d="M528.9,426.6c-1.5,0.9-2.8,1.7-4.1,2.4c-9.3,5.8-19.8,7.7-30.6,7.3c-7.1-0.4-13.8-1.5-20.4-4.5
		...
		C519.7,393.9,515.5,393.9,511.2,393.9z"
                      ...
                      <path
                        fill="black"
                        d="M870.1,427.1c-3-0.4-5.6-0.6-8-1.1c-8.4-1.5-15.1-5.8-20.4-12.5c-5.8-7.5-9.3-15.9-12.1-24.7
		...
		c3.7,0.2,7.7,0.6,11.4,1.1c5.4,0.9,10.1-0.6,13.6-4.7C867.1,436.7,868.8,432.2,870.1,427.1z"
                      ...
                      <path
                        fill="black"
                        d="M380.8,385.1c0-14.2-0.4-28.2,0.2-42.4c0.2-5.6,1.5-11.4,3.2-16.8c3.7-11.2,12.5-17,23.5-19.6
		...
		c0,17.2,0,34.4,0,51.7c0,5.2-1.7,6.9-6.9,6.9c-5.4,0-11,0-16.4,0c-5,0-6.7-1.7-6.7-6.7C380.6,413.5,380.6,399.3,380.8,385.1z"
                      ...
                      <path
                        fill="black"
                        d="M766.1,347.2c2.8-1.9,4.9-3.4,6.9-4.7c9.7-6.3,20.5-8.2,31.9-8.2c3.2,0,5.2,2.1,5.4,5.4
		...
		c6.2,0,12.3,0,18.5,0c3.7,0,5.6,2.1,5.8,5.8C766.1,343.5,766.1,345,766.1,347.2z"
                      ...
                      <path
                        fill="black"
                        d="M333.9,384.4c0,64.4-52.1,116.5-116.5,116.5c-12.3,0-24.1-1.9-35.1-5.4c-16.6-5.2-31.7-14.2-44.3-26
		...
		C320.7,322.9,333.9,352.1,333.9,384.4z"
                      ...
                      <path
                        fill="white"
                        d="M271.4,433.9l-15.7-7.8c0,0-26.7,48.7-73.6,69.5c-16.6-5.2-31.7-14.2-44.3-26c10.3-1.5,26.9-6.7,44.3-23.9
		...
		C276.8,433.1,274,435.2,271.4,433.9z"
                      ...
                      <path
                        fill="white"
                        d="M287.6,366.4c-1.3,3.4-6.2,2.8-6.7-0.7l-3.5-20.5l-26.5,8.2c-3,0.9-5.6-2.1-4.3-4.9c3.5-7.5,8.6-20,12.7-36
